...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Edit Encounter</h3>
            ...
            <div class="card card-bordered card-full">
                ...
                <div class="card card-preview">
                    <div class="card-inner">
                        <form action="{{ route('encounter-update', $id_ubah) }}" method="POST">
                            @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text"
                                                    ...
                                                    value="{{ old('original_code', $data_encounter->original_code) }}" />
                                                @error('original_code')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('subject_nik',$data_encounter->subject_nik) }}" />
                                                @error('subject_nik')
                                                <div class="alert alert-sm alert-danger alert-custom">{{ $message }}
                                                </div>
                                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" readonly
                                                    ...
                                                    value="{{ old('subject_reference',$data_encounter->subject_reference) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" readonly
                                                    ...
                                                    value="{{ old('subject_display',$data_encounter->subject_display) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number" readonly
                                                    ...
                                                    value="{{ old('participant_nik',$data_encounter->participant_nik) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" readonly
                                                    ...
                                                    value="{{ old('participant_individual_reference',$data_encounter->participant_individual_reference) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" readonly
                                                    ...
                                                    value="{{ old('participant_individual_display',$data_encounter->participant_individual_display) }}" />
                                            ...
                                            <div class="form-control-wrap">
                                                <div class="form-control-select">
                                                    <select
                                                        ...
                                                        <option {{ old('location_reference',$data_encounter->
                                                            location_reference)==$item_location->
                                            ...
                                            <div class="form-control-wrap">
                                                <div class="form-control-select">
                                                    <select
                                                        ...
                                                        <option {{ old('jenis_rawat',$data_encounter->
                                                            jenis_rawat)==$item_rawat['kode'] ? 'selected'
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('period_start',date(" m/d/Y",
                                                    strtotime($data_encounter->period_start))) }}" />
                                                @error('period_start')
                                                <div class="alert alert-sm alert-danger alert-custom">{{ $message }}
                                                </div>
                                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('period_start_hour',(int)date(" H",
                                                    strtotime($data_encounter->period_start))) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number"
                                                    ...
                                                    placeholder="Jam" value="{{ old('period_start_minute',(int)date("
                                                    i", strtotime($data_encounter->period_start))) }}"
                                                id="period_start_minute"
                                                name="period_start_minute" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="period_end" value="{{ old('period_end',date(" m/d/Y",
                                                    strtotime($data_encounter->period_end))) }}" id="period_end"/>
                                                @error('period_end')
                                                <div class="alert alert-sm alert-danger alert-custom">{{ $message }}
                                                </div>
                                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('period_end_hour',(int)date(" H",
                                                    strtotime($data_encounter->period_end))) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('period_end_minute',(int)date(" i",
                                                    strtotime($data_encounter->period_end))) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('status_history_arrived_start',date(" m/d/Y",
                                                    strtotime($data_encounter->status_history_arrived_start))) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number"
                                                    ...
                                                    placeholder="Jam"
                                                    value="{{ old('status_history_arrived_hour',(int)date(" H",
                                                    strtotime($data_encounter->status_history_arrived_start))) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('status_history_arrived_minute',(int)date(" i",
                                                    strtotime($data_encounter->status_history_arrived_start))) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('status_history_inprogress_start',date(" m/d/Y",
                                                    strtotime($data_encounter->status_history_inprogress_start))) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('status_history_inprogress_hour',(int)date(" H",
                                                    strtotime($data_encounter->status_history_inprogress_start))) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('status_history_inprogress_minute',(int)date(" i",
                                                    strtotime($data_encounter->status_history_inprogress_start))) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('status_history_finished_start',date(" m/d/Y",
                                                    strtotime($data_encounter->status_history_finished_start))) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('status_history_finished_hour',(int)date(" H",
                                                    strtotime($data_encounter->status_history_finished_start))) }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('status_history_finished_minute',(int)date(" i",
                                                    strtotime($data_encounter->status_history_finished_start))) }}" />
