...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Diagnostic Report (Lab)</h3>
      ...
      var table = $('.data-table').DataTable({
          ...
          columns: [
            ...
            //   {data: 'id', name: 'id'},
              ...
              {data: 'satusehat_statuscode_diagnostic_report', name: 'satusehat_statuscode_diagnostic_report'},
