<div class="nk-upload-form">
    <h5 class="title mb-3">Hapus Snomed</h5>
</div>
<div class="nk-upload-list">
    <form action="{{ route('snomed-hapus-data') }}" method="POST" id="form-action">
        @csrf
        <div class="row g">
            <div class="col-md-12">
                <div class="form-group">
                    <input type="hidden" name="id_hapus" readonly value="{{ Crypt::encrypt($data_snomed->id) }}">
                    <label class="form-label" for="original_code">Keterangan</label>
                    <div class="form-control-wrap">
                        <input name="snomed_display" readonly value="{{ $data_snomed->snomed_display }}" type="text"
