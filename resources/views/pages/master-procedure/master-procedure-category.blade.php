<div class="nk-upload-form">
    <h5 class="title mb-3">Pilih Kategori</h5>
...
<div class="nk-upload-list">
    ...
    <div class="card card-preview">
        ...
        <table class="table table-bordered data-table-category mt-3">
            <thead>
                <tr>
                    <th>Keterangan</th>
                    <th>Pilih</th>
...
var url   ='{{ route("master-procedure-category-data",":id") }}';
...
var table = $('.data-table-category').DataTable({
    ...
    //   {data: 'id', name: 'id'},
        ...
        {data: 'pilih_category', name: 'pilih_category', orderable: false, searchable: false},
    ]
    });
});
</script>