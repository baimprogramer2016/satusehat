...
<div class="nk-upload-list">
    <div class="row g">
            ...
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input name="name" readonly
                        value="{{ $data_medication_request->encounter_original_code.' - '.$data_medication_request['subject_display'] }}"
        ...
        <div class="col-md-12 mt-3">
            <div class="form-group">
                <button id='kirim-ss' onclick="kirimSatuSehat('{{ Crypt::encrypt($data_medication_request->id) }}')"
