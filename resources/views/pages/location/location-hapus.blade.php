<div class="nk-upload-form">
    <h5 class="title mb-3">Hapus Lokasi</h5>
</div>
<div class="nk-upload-list">
    <form action="{{ route('lokasi-hapus-data') }}" method="POST" id="form-action">
        @csrf
        <div class="row g">
            <div class="col-md-12">
                <div class="form-group">
                    <input type="hidden" name="id_hapus" value="{{ Crypt::encrypt($data_location->id) }}">
                    <label class="form-label" for="original_code">Nama</label>
                    <div class="form-control-wrap">
                        <input name="name" readonly value="{{ $data_location->name }}" type="text"
