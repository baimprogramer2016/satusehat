...
<div class="nk-upload-list">
    <div class="row g">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input name="name" readonly value="{{ $data_rencana_tindak_lanjut->encounter_original_code }}"
        ...
        <div class="col-md-12 mt-3">
            <div class="form-group">
                <button id='kirim-ss' onclick="kirimSatuSehat('{{ Crypt::encrypt($data_rencana_tindak_lanjut->id) }}')"
