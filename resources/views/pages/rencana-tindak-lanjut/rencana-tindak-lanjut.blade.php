...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Rencana Tindak Lanjut</h3>
...
<script type="text/javascript">
    function load_datatable(p_status_kirim = 'success', p_tanggal_awal = null, p_tanggal_akhir=null){
      ...
      var table = $('.data-table').DataTable({
          ...
          ajax: {
            url : "{{ route('rencana-tindak-lanjut') }}",
            data : {
    ...
    function modalResponseSS(id)
    {
        ...
        var url     = '{{ route("rencana-tindak-lanjut-response-ss", ":id") }}';
    ...
    function modalKirimSS(id)
    {
        ...
        var url     = '{{ route("rencana-tindak-lanjut-modal-kirim-ss", ":id") }}';
        url         = url.replace(':id',id);
        $.ajax({
            type:"GET",
            url:url,
    ...
    function kirimSatuSehat(id)
    {
        ...
        $(".result-message").html('...');
        var url     = '{{ route("rencana-tindak-lanjut-kirim-ss", ":id") }}';
        url         = url.replace(':id',id);
