...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Prognosis</h3>
...
<script type="text/javascript">
    ...
    function modalResponseSS(id)
    {
        ...
        var url     = '{{ route("prognosis-response-ss", ":id") }}';
    ...
    function modalKirimSS(id)
    {
        ...
        var url     = '{{ route("prognosis-modal-kirim-ss", ":id") }}';
        url         = url.replace(':id',id);
        $.ajax({
            type:"GET",
            url:url,
    ...
    function kirimSatuSehat(id)
    {
        ...
        $(".result-message").html('...');
        var url     = '{{ route("prognosis-kirim-ss", ":id") }}';
        url         = url.replace(':id',id);
