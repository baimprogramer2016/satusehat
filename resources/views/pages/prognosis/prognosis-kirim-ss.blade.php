...
<div class="nk-upload-list">
    <div class="row g">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input name="name" readonly value="{{ $data_prognosis->encounter_original_code }}" type="text"
        ...
        <div class="col-md-12 mt-3">
            <div class="form-group">
                <button id='kirim-ss' onclick="kirimSatuSehat('{{ Crypt::encrypt($data_prognosis->id) }}')"
