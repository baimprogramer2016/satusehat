...
class CompositionJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $data_data = $this->composition_repo->getDataCompositionReadyJob();
        ...
        if ($data_data->count() > 0) {
            ...
            foreach ($data_data as $item_data) {
                ...
                # API POST Bundle
                $payload_composition = $this->bodyManualComposition($item_data, $data_parameter);
                ...
                if ($response->successful()) {
                    ...
                    if ($body_parse->resourceType == 'OperationOutcome') {
                        ...
                        $this->composition_repo->updateStatusComposition($id, $satusehat_id, $payload_composition, $response);
                    }
                } else {
                    $this->composition_repo->updateStatusComposition($id, $satusehat_id, $payload_composition, $response);
                }
