...
class AllergyJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $data_data = $this->allergy_repo->getDataAllergyReadyJob();
        ...
        if ($data_data->count() > 0) {
            ...
            foreach ($data_data as $item_data) {
                ...
                # API POST Bundle
                $payload_allergy = $this->bodyManualAllergy($item_data, $data_parameter);
                ...
                if ($response->successful()) {
                    ...
                    if ($body_parse->resourceType == 'OperationOutcome') {
                        ...
                        $this->allergy_repo->updateStatusAllergy($id, $satusehat_id, $payload_allergy, $response);
                    }
                } else {
                    $this->allergy_repo->updateStatusAllergy($id, $satusehat_id, $payload_allergy, $response);
                }
