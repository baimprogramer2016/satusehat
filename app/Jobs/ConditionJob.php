...
class ConditionJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $data_data = $this->condition_repo->getDataConditionReadyJob();
        ...
        if ($data_data->count() > 0) {
            ...
            foreach ($data_data as $item_data) {
                ...
                # API POST Bundle
                $payload_condition = $this->bodyManualCondition($item_data);
                ...
                if ($response->successful()) {
                    ...
                    if ($body_parse->resourceType == 'OperationOutcome') {
                        ...
                        $this->condition_repo->updateStatusCondition($id, $satusehat_id, $payload_condition, $response);
                    }
                } else {
                    $this->condition_repo->updateStatusCondition($id, $satusehat_id, $payload_condition, $response);
                }
