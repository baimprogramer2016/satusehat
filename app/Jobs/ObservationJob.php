...
class ObservationJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $data_data = $this->observation_repo->getDataObservationReadyJob();
        ...
        if ($data_data->count() > 0) {
            ...
            foreach ($data_data as $item_data) {
                ...
                # API POST Bundle
                $payload_observation = $this->bodyManualObservation($item_data);
                ...
                if ($response->successful()) {
                    ...
                    if ($body_parse->resourceType == 'OperationOutcome') {
                        ...
                        $this->observation_repo->updateStatusObservation($id, $satusehat_id, $payload_observation, $response);
                    }
                } else {
                    $this->observation_repo->updateStatusObservation($id, $satusehat_id, $payload_observation, $response);
                }
