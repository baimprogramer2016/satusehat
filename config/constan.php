...
return [
    ...
    "error_message" => [
        ...
        "error_service_request_no" => "Service Request Harus di kirim Terlebih Dahulu",
        "error_specimen_no" => "Speciment Harus di kirim Terlebih Dahulu",
        "error_observation_no" => "Observation Harus di kirim Terlebih Dahulu",
    ],
    "fhir" => [
